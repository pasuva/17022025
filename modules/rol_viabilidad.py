...
def mostrar_tabla_viabilidades(df_viabilidades, comercial_usuario):
    ...
    # Obtener usuarios con rol "viabilidad" desde la base de datos
    try:
        conn = get_db_connection()
        cursor = conn.cursor()
    ...
    # Si hay usuarios con rol "viabilidad", filtrar las viabilidades
    if usuarios_viabilidad:
        # Buscar la columna que contiene el usuario creador
        ...
        if columna_usuario:
            ...
            df_viabilidades = df_viabilidades[df_viabilidades[columna_usuario].isin(usuarios_viabilidad)]
        else:
